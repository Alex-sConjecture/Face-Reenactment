...
class SAEModel(ModelBase):
    ...
    def onInitialize(self, **in_options):
        ...
        if self.is_training_mode:
            ...
            self.dst_train = K.function ([warped_src, target_src, target_srcm, warped_dst, target_dst, target_dstm ],[dst_loss], optimizer().get_updates(dst_loss, dst_loss_train_weights) )
    ...
    def onTrainOneEpoch(self, sample):
        ...
        dst_loss, = self.dst_train ([warped_src, target_src, target_src_mask, warped_dst, target_dst, target_dst_mask])
